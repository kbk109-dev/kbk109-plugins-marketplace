...
규칙 3절의 "커밋 전 반드시 실행" 줄에 넣을 명령을 정한다. 순서대로 시도한다:
...
| 인자 | 용도 |
|---|---|
| `--pre-commit-check` | 규칙 3절에 들어갈 검증 명령. 생략하면 해당 줄 삭제 |
