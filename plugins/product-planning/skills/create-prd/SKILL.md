---
name: create-prd
description: "Turns a Notion page, meeting note, or requirements memo into a PRD with the ten canonical sections (Overview, User Stories, Functional/Non-Functional Requirements, User Flow, Acceptance Criteria, Dependencies, Risks, Success Metrics), derives Given-When-Then acceptance criteria per requirement, marks self-drafted metrics [제안], then cross-reviews with design/engineering/QA subagents before writing docs/plan/PRD-{slug}.md. Trigger: 'PRD 만들어줘', '기획서를 PRD로 정리해줘', '수용기준 뽑아줘'."
---
