...
[![Marketplace](https://img.shields.io/badge/marketplace-1.11.0-blue)](./docs/release/v1.11.0.md)
...
현재 마켓플레이스 버전은 **1.11.0**이다. 변경 내역은 [CHANGELOG](./CHANGELOG.md),
이번 태그 노트는 [docs/release/v1.11.0.md](./docs/release/v1.11.0.md) 를 본다.
